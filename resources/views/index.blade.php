...
<div class="row g-4 mb-3">
    <div class="col-sm-auto">
        <div>
            <a href="" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
        </div>
    </div>
    <div class="col-sm">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <div class="text-muted">
                            <i class="ri-calendar-event-fill me-1 align-bottom"></i> 10/05/2023
                        </div>
                    </div>
