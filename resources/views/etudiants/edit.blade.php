            ...
            <div class="card mt-n5">
                <div class="card-body p-4">
                    <div class="text-center">
                        ...
                        <h5 class="fs-16 mb-1">{{$eleve->Nom}}</h5>
                        <p class="text-muted mb-0">{{$eleve->classe->nom_classe}}</p>
                    </div>
                </div>
            </div>
            <!--end card-->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="firstnameInput" placeholder="Enter your firstname" value="{{$eleve->Nom}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="lastnameInput" placeholder="Enter your lastname" value="{{$eleve->Nom_pere}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="phonenumberInput" placeholder="Enter your phone number" value="{{$eleve->tel_pere}}">
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-6">
