...
<div class="row g-4 mb-3">
    <div class="col-sm-auto">
        <div>
            <a href="" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModalgrid"><i class="ri-add-line align-bottom me-1" ></i> Nouveau Categorie</a>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-column h-100">
                    ...
                    <div class="mt-auto">
                        <div class="d-flex mb-2">
                            <div class="flex-grow-1">
                                <div>{{$categorie->nom_categorie}}</div>
                            </div>
                            <div class="flex-shrink-0">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-shrink-0">
                        <div class="text-muted">
                            <i class="ri-calendar-event-fill me-1 align-bottom"></i> {{$categorie->created_at}}
                        </div>
                    </div>
            ...
            <div class="modal-body">
                <form action="{{ route('categories.store')}}" method="post">
                    ...
                    <div class="row g-3">
                        <div class="col-xxl-6">
                            <div>
                                <label for="firstName" class="form-label">Nom du Categorie</label>
                                <input type="text" class="form-control" id="firstName" name="nom_categorie" placeholder="Nom du Categorie">
                            </div>
                        </div><!--end col-->
